...
def warp_kpts(kpts0, depth0, depth1, T_0to1, K0, K1):
    ...
    """
    kpts0_long = kpts0.round().long().clip(0, depth0.shape[-1]-1)
...
def spvs_coarse(data, scale = 8):
    ...
    if data['image0'].dim() == 3:
        ...
        data['depth0'] = data['depth0'][None]
        data['depth1'] = data['depth1'][None]
        data['T_0to1'] = data['T_0to1'][None]
        data['T_1to0'] = data['T_1to0'][None]
        data['K0'] = data['K0'][None]
        data['K1'] = data['K1'][None]
        data['scale0'] = data['scale0'][None]
        data['scale1'] = data['scale1'][None]
